...
function plughaus_create_pages_admin_page() {
    ...
    ?>
    <div class="wrap">
        <h1>Create PlugHaus Studios Pages</h1>
        
        <?php if (isset($_POST['create_pages'])): ?>
            <div class="notice notice-success"><p>Pages created successfully!</p></div>
        <?php endif; ?>
        
        <p>This will create all the necessary pages for the PlugHaus Studios website.</p>
...
function plughaus_create_all_pages() {
    ...
    $pages_to_create = array(
        ...
        'about' => array(
            'title' => 'About Us',
            'content' => 'Learn about PlugHaus Studios and our mission to create professional WordPress plugins for modern businesses.',
        ...
        'blog' => array(
            'title' => 'Blog',
            'content' => 'Stay updated with the latest news, tutorials, and insights from the PlugHaus Studios team.',
