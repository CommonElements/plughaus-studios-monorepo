 ...
 * Handles checkout creation and processing for PlugHaus Studios products
 */
...
class PlugHaus_Stripe_Checkout {
    ...
    private function send_confirmation_email($session, $purchase_data) {
        ...
        $subject = 'Thank you for your purchase from PlugHaus Studios';
        
        $message = "
        <h2>Purchase Confirmation</h2>
        <p>Thank you for purchasing {$purchase_data['product_name']} from PlugHaus Studios!</p>
        ...
        <p>Best regards,<br>The PlugHaus Studios Team</p>
        ";
