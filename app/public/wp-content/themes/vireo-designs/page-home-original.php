                    ...
                    <div class="hero-demo">
                        <div class="demo-window">
                            <div class="demo-header">
                                ...
                                <div class="demo-title">Vireo Dashboard</div>
                            </div>
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"Vireo Property Management has transformed how we handle our rental portfolio. The automation features alone save us 20+ hours per week."</p>
                    </div>
                ...
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>"Outstanding support team and rock-solid plugins. We've built our entire business platform on Vireo solutions."</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <i class="fas fa-user"></i>
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <p class="cta-description">
                    Join thousands of satisfied customers who trust Vireo Designs for their business needs.
                </p>
