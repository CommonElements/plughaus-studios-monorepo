        ...
        <div class="container">
            <div class="page-hero-content">
                <h1 class="page-hero-title">
                    About <span class="text-gradient">Vireo Designs</span>
                </h1>
        ...
        <div class="container">
            <div style="max-width: 800px; margin: 0 auto; text-align: center;">
                ...
                <p style="font-size: 1.25rem; line-height: 1.6; color: var(--gray-600); margin-bottom: 2rem;">
                    ...
                    Vireo Designs specializes in creating professional-grade plugins that small and medium businesses can actually use.
                </p>
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <p class="cta-description" style="color: var(--gray-600);">
                    Start with our free plugins and see why thousands of businesses trust Vireo Designs.
                </p>
