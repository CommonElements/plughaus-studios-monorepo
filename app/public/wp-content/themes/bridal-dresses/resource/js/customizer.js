...
(function($) {
    ...
    bridal_dresses_section_lists.forEach(bridal_dresses_homepage_scroll_preview);

    function bridal_dresses_homepage_scroll_preview(item, index) {
        ...
        wp.customize.bind('preview-ready', function() {
            ...
            wp.customize.preview.bind(item, function(data) {
                ...
                if (true === data.expanded) {
                    $('html, body').animate({
                        'scrollTop': $('#bridal_dresses_' + item + '_section').position().top
                    });
                }
            });
...
(function($) {
    wp.customize('bridal_dresses_enable_sticky_header', function(value) {
...
(function($) {
    wp.customize('bridal_dresses_enable_breadcrumb', function(value) {
        value.bind(function(newval) {
            if (newval) {
...
(function($) {
    wp.customize('bridal_dresses_website_layout', function(value) {
        value.bind(function(newval) {
            if (newval) {
...
(function($) {
    wp.customize('bridal_dresses_layout_width_margin', function(value) {
        value.bind(function(newval) {
...
( function( $ ) {
    wp.customize( 'bridal_dresses_sidebar_width', function( value ) {
        value.bind( function( newval ) {
...
(function($) {
    wp.customize('bridal_dresses_site_logo_width', function(value) {
        value.bind(function(newval) {
