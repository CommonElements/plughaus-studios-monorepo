...
class PHPM_Frontend_Settings_Admin {
    ...
    public static function init() {
        // Frontend page settings are now integrated into main settings
        // Only keep AJAX handlers for page creation functionality
    ...
    public static function enqueue_scripts($hook) {
        ...
        wp_enqueue_script(
            ...
            PHPM_PLUGIN_URL . 'core/assets/js/frontend-settings-admin.js',
            array('jquery'),
            PHPM_VERSION,
            true
        );
        ...
        wp_enqueue_style(
            'phpm-frontend-settings-admin',
            PHPM_PLUGIN_URL . 'core/assets/css/frontend-settings-admin.css',
            array(),
            PHPM_VERSION
        );
    }
